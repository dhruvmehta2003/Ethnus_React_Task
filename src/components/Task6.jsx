...
const Task6 = () =>{
    ...
    return(
        <>
            ...
            <div class="container">
                <a class="navbar-brand" href="#top">Dhruv Mehta</a>
            ...
            <section class="bgimage" id="home">
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hero-text">
                        <h2 class="hero_title">Hi, it's me Dhruv</h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="https://dhruvmehta2003.github.io/QR-Code-Generator/" class="btn btn-success" target="_blank" rel="noreferrer">Link</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer id="footer">
            <div class="container-fluid">
                <div class="social-icons mt-4">
                    <a href="https://www.facebook.com/profile.php?id=100080047054632" target="_blank" rel="noreferrer"><i class="fab fa-facebook"></i></a>
                    <a href="https://www.instagram.com/dhruvmehta2003/" target="_blank" rel="noreferrer"><i class="fab fa-instagram"></i></a>
                    <a href="https://www.linkedin.com/in/dhruv-mehta-b50b8a235/" target="_blank" rel="noreferrer"><i class="fab fa-linkedin"></i></a>
                </div>
            </div>
        </footer>
    </>
